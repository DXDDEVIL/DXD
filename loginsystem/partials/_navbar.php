...
<div class="container-fluid">
    <a class="navbar-brand" href="/dxd/loginsystem">iSecure</a>
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="/dxd/loginsystem/welcome.php">Home</a>
            </li>';

if (!$loggedin) {
    echo '
    <li class="nav-item">
        <a class="nav-link" href="/dxd/loginsystem/login.php">Login</a>
    </li>
    <li class="nav-item">
